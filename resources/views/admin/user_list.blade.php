        ...
        <div class="card">
            <div class="card-body">
                <div class="page-title">
                    ...
                    <div>
                        <a class="btn btn-primary" title="Add User" href="{{ route('Admin.AddUser') }}">Add User</a>
                    </div>
                    ...
                    {{-- <div>
                        <form>
                            @csrf
                            <div class="row">
                                <div class="col-lg-8 position-relative form-input-wrap">
                                ...
                                @if ($partnerusers->isNotEmpty())
                                    @foreach ($partnerusers as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('Admin.UserPermission', ['uid' => base64_encode($user->user_id)]) }}"
                                            ...
                                            <td>
                                                <span class="badge rounded-pill">
                                                    <a href="{{ route('Admin.EditUser', ['uid' => base64_encode($user->user_id)]) }}"
                                                        type="button" title="Edit Property"
                                                        class="btn btn-success edit-main-category">
                                                        <i class="ri-edit-box-line"></i>
                                                    </a>
                                                    <a href="{{ route('Admin.DeleteUser', ['uid' => $user->user_id]) }}"
                                ...
                                @if ($invsetorusers->isNotEmpty())
                                    @foreach ($invsetorusers as $iuser)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge rounded-pill">
                                                    <a href="{{ route('Admin.EditUser', ['uid' => base64_encode($iuser->user_id)]) }}"
                                                        type="button" title="Edit Property"
                                                        class="btn btn-success edit-main-category">
                                                        <i class="ri-edit-box-line"></i>
                                                    </a>
                                                    <a href="{{ route('Admin.DeleteUser', ['uid' => $iuser->user_id]) }}"
                                                        class="btn btn-danger"
                                                        onclick="return confirm('Are you sure you want to delete this user?')">
                                                        <i class="ri-delete-bin-line"></i>
                                                    </a>
