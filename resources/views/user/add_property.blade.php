...
@section('body')
    ...
    <section class="section">
        ...
        <form method="post" action="{{ route('User.SaveProperty') }}" class="row g-3 needs-validation" novalidate
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 position-relative form-input-wrap">
                                    ...
                                    <input type="text" placeholder="General Partner Share %:"
                                        class="form-control number-input" value="20" name="generalpartnershare"
                                ...
                                <div class="col-lg-6 position-relative form-input-wrap">
                                    ...
                                    <input type="text" placeholder="Investor Share %"
                                        class="form-control number-input" value="80" name="investorshare" id="investorshare"
                                        required>
                                    <div class="invalid-feedback">
